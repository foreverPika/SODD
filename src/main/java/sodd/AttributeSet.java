...
//    public static long getSizeTime;
//    private static util.Timer timer = new util.Timer();
    ...
    public int getFirstAttribute() {
        ...
        throw new RuntimeException("not find attribute");
    }
    ...
    public static AttributeSet fromString(String str) {
        ...
        for (String part : parts) {
            try {
                int attribute = Integer.parseInt(part.trim()) - 1;
                if (attribute < 0 || attribute >= 64) {
                    throw new IllegalArgumentException("attribute exceed" + attribute);
                }
                value |= (1L << attribute);
            } catch (NumberFormatException e) {
                throw new IllegalArgumentException("invalid format of attribute" + part, e);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        String s1 = "{1,2,5,6}";
        System.out.println(fromString(s1));
